...
Criação de um NotebookLM para estudos

Fazendo um expert em fundos imobiliários.
...
"Agora você é um expert em fundos imobiliários, você vai me ajudar e buscar melhores investimentos nesta área."

O NotebookLM já importou alguns dados de Guia Completo de Investimento em Fundos Imobiliários.
...
Quero que ele me ajude a montar uma estratégia para ganhar 1000 reais por mês. Mas primeiramente vou fazer tb algumas perguntas que tenho dúvida:

Me explique o que são fundos de tijolo e papel por exemplo?
Como organizar minha carteira de fundos usando uma planilha completa?
Quais as vantagens tributárias dos rendimentos para pessoa física?
Como funciona a estratégia do jumento para investir em FIIs?
Quais fundos imobiliários o BTG Pactual recomenda para 2026?


Aí fiquei interessada sobre a estratégia do jumento e fiz os seguintes prompts: 

Através da "estratégia do Jumento", resolvi pesquisar mais e fazer meu NLM como um consultor de investimentos do dia a dia, e me ajudar a aprimorar mais:

Pedi para ele criar um resumo em vídeo:
Explique como funciona a estratégia do jumento e como aplicar
- Use um exemplo real de um fundo de tijolo para ilustrar a estratégia.
...
Este glossário reúne os principais termos e conceitos que compõem a Estratégia do Jumento, um método de investimento em Fundos Imobiliários (FIIs) focado na automação e simplificação da tomada de decisão.

**Conceitos Fundamentais**

André Bassi: Investidor criador da estratégia, que a batizou com este nome para enfatizar a importância da simplicidade e eficiência no processo de investir

Constância e Tranquilidade: Os dois pilares psicológicos da estratégia. O objetivo é que o investidor mantenha aportes regulares sem o estresse de análises exaustivas a cada novo investimento

Diferenciação de Ativos: A estratégia faz uma distinção forte entre as classes de fundos, especificamente entre fundos de tijolo (imóveis físicos) e fundos de papel (recebíveis imobiliários), o que impacta diretamente na sugestão de alocação

Simplicidade: A filosofia de que o investimento não deve ser complexo para ser rentável, permitindo que qualquer investidor siga o método através de ferramentas automatizadas

**Indicadores e Técnica**

Médias Curtas e Longas: Indicadores matemáticos calculados pela estratégia para monitorar a tendência de indicadores macroeconômicos e orientar o momento de aportar em cada classe de fundo

Rebalanceamento Automático: Ajuste dinâmico dos pesos da carteira. Dependendo do cruzamento das médias, a estratégia pode alterar automaticamente a distribuição ideal (por exemplo, mudando de uma proporção de 70% em um setor e 30% em outro para 50/50)

Script de Aporte: Algoritmo ou código executado dentro de uma planilha que processa os dados da carteira do investidor e os indicadores de mercado para gerar sugestões de investimento

Taxa Selic: O principal indicador macroeconômico acompanhado pela estratégia para definir a atratividade relativa entre os diferentes tipos de fundos imobiliários

**Sinais de Operação**

Aguardar: Sinal gerado pelo sistema quando um ativo não está em uma posição favorável de preço ou peso na carteira para receber novos aportes naquele momento

Comprar: Indicação automática de que o ativo está em uma janela de oportunidade e deve receber parte do capital do novo aporte

Vender (ou Excluir do Cálculo): Opção técnica para retirar um papel específico dos cálculos de novos aportes, caso o investidor decida encerrar ou reduzir drasticamente sua posição

**Ferramentas de Suporte**

Aba Aporte: Local na planilha de acompanhamento onde o investidor insere o valor que deseja investir e "roda" a Estratégia do Jumento para receber as instruções

Aba Info: Espaço destinado à explicação dos indicadores que afetam a alocação e a lógica por trás dos cálculos da estratégia
